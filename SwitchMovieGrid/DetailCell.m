...
- (void) builtCell
{
    ...
    double frameRatio= [[SwitchHelper sharedInstance] frameRatio];
    ...
    _ScoreLabel=[[RTLabel alloc] initWithFrame:CGRectMake(180*frameRatio, 20*frameRatio, 270*frameRatio,100)];
    ...
    _Score=[[RTLabel alloc] initWithFrame:CGRectMake(180*frameRatio, 40*frameRatio, 270*frameRatio,100)];
    ...
    _RatingLabel=[[RTLabel alloc] initWithFrame:CGRectMake(180*frameRatio, 80*frameRatio, 270*frameRatio,100)];
    ...
    _Rating=[[RTLabel alloc] initWithFrame:CGRectMake(180*frameRatio, 100*frameRatio, 270*frameRatio,100)];
    ...
    _ReleaseDayLabel=[[RTLabel alloc] initWithFrame:CGRectMake(180*frameRatio, 140*frameRatio, 270*frameRatio,100)];
    ...
    _ReleaseDay=[[RTLabel alloc] initWithFrame:CGRectMake(180*frameRatio, 160*frameRatio, 270*frameRatio,100)];
    ...
    _title=[[RTLabel alloc] initWithFrame:CGRectMake(20*frameRatio, 230*frameRatio, 270*frameRatio,100)];
